...
def save_data_is_contained_next_color_for_illustrators(illutrator_list):
    ...
    for illutrator_name in illutrator_list:
        ...
        input_file_path = f"src/color_recommendation/data/output/recommend_colors/recommend_colors_{illutrator_name}.json"
        ...
        output_file_path = f"src/color_recommendation/data/output/is_contained_next_color/is_contained_next_color_{illutrator_name}.json"
